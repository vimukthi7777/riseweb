...
const footerSocials = [
  { name: "YOUTUBE", href: "https://www.youtube.com/@risegaminglk" },
  { name: "TIKTOK", href: "https://www.tiktok.com/@risegaming_lk" },
  { name: "DISCORD", href: "https://discord.gg/riselk" },
...
export default function ContactSection() {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .sendForm(
        "service_kv4orwt",   // Replace with your EmailJS Service ID
        "template_wgnqzwq",  // Replace with your EmailJS Template ID
        form.current,
        {
          publicKey: "kvQo4nQLOw-sBzrFi", // Replace with your EmailJS Public Key
        }
      )
      .then(
        () => {
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <div className="text-white font-bold">support.riselk@gmail.com</div>
                </div>
              </div>
          ...
          <div className="bg-zinc-900/50 border border-white/5 p-8 md:p-12 rounded-[40px]">
            <form ref={form} onSubmit={sendEmail} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  name="subject"
                  className="w-full bg-black border border-white/10 rounded-2xl p-4 text-white focus:outline-none focus:border-[#08D2C2] transition-colors appearance-none"
                >
              ...
              {status.message && (
                <div
                  className={`p-4 rounded-xl text-xs font-bold uppercase tracking-wider ${
                    status.type === "success"
                      ? "bg-[#08D2C2]/10 text-[#08D2C2] border border-[#08D2C2]/20"
              ...
              <button
                type="submit"
                disabled={isSending}
                className="w-full bg-[#08D2C2] hover:bg-[#07b5a5] disabled:opacity-50 text-black font-black py-5 uppercase tracking-widest rounded-2xl transition-all shadow-[0_0_40px_rgba(8,210,194,0.1)] cursor-pointer"
              >
