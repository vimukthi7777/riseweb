        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <div className="flex flex-col sm:flex-row items-start justify-start gap-6">
              ...
              <a href="https://discord.gg/74RtuZmh2" className="w-full sm:w-auto bg-[#5865F2] hover:bg-white/10 border border-white/10 text-white font-black py-5 px-12 uppercase tracking-widest rounded-xl transition-all">
                Join Discord
              </a>
            </div>
          </div>
